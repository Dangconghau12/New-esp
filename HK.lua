--[[
  Universal ESP + Team + Health + Tracers + Hitbox + Aimbot + Menu tròn + FOV Circle
  By Conghau — 2025-08-16

  Features:
    - Menu hình tròn nhỏ cố định, bấm vào mở bảng menu, bấm lại thu về hình tròn.
    - Aim bật: vẽ vòng FOV trắng giữa màn hình, bán kính theo FOV nhập trong menu.
    - ESP, Tracer, Hitbox thân/đầu (nhập số 5-20), bảng tên + khoảng cách, auto update.
    - Tương thích mọi game, mọi map Roblox.
]]
...
local function createUI()
    ...
    menuFrame.Position = UDim2.new(0, 80, 0.5, -170)
    ...
    -- Khi bấm vào hình tròn: hiện/ẩn menu
    ...
    -- Các thành phần menu bên trong menuFrame
